...
L'installateur vous demandera une clé API de recherche - rendez-vous simplement sur [la plateforme ouverte iFlow](https://docs.iflow.cn/en/docs/), récupérez votre clé gratuite, et collez-la. Un jeu d'enfant ! 🔑
